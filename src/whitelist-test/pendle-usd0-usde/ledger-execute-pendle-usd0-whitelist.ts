...
const run = async () => {
    console.log(`Start whitelisting USD0++ PT on ${hre.network.name}...`)
    ...
    const pendleUsd0WhitelistSecurity = new PendleUsd0Whitelist(process.env.INVESTMENT_ROLES_ADDRESS, ledgerSigner);
