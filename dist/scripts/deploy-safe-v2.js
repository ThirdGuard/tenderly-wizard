...
exports.removeDeployerAsOwner = exports.addSafeSigners = exports.deploySafeV2 = void 0;
const safe_master_copy_v2_json_1 = __importDefault(require("../contracts/safe_master_copy_v2.json"));
const safe_proxy_factory_v2_json_1 = __importDefault(require("../contracts/safe_proxy_factory_v2.json"));
...
async function removeDeployerAsOwner(safeAddr, threshold) {
    ...
    if (isDeployerStillOwner) {
        ...
        await safe
            .connect(caller)
            .execTransaction(safeAddr, constants_1.tx.zeroValue, removeOwnersPopTx.data, constants_1.tx.operation, constants_1.tx.avatarTxGas, constants_1.tx.baseGas, constants_1.tx.gasPrice, constants_1.tx.gasToken, constants_1.tx.refundReceiver, signature, {
            gasLimit: constants_1.GAS_LIMIT,
        });
