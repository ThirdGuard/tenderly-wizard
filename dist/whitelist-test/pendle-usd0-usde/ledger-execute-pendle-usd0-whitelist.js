...
const run = async () => {
    console.log(`Start whitelisting USD0++ PT on ${hardhat_2.default.network.name}...`);
    ...
    const pendleUsd0WhitelistSecurity = new scope_pendle_usd0_1.PendleUsd0Whitelist(process.env.INVESTMENT_ROLES_ADDRESS, ledgerSigner);
