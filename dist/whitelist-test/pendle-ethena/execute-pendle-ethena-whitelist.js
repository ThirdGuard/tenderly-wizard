...
const scope_pendle_ethena_1 = require("./scope-pendle-ethena");
// npx hardhat run src/whitelist/execute-pendle-ethena-whitelist.ts --network localhost
const run = async () => {
    console.log(`Start whitelisting USDE PT on ${hardhat_1.network.name}...`);
    ...
    const pendleEthenaWhitelistSecurity = new scope_pendle_ethena_1.PendleEthenaWhitelist(process.env.INVESTMENT_ROLES_ADDRESS, ledgerSigner);
