...
const scope_sdai_1 = require("./scope-sdai");
// npx hardhat run src/whitelist/execute-sdai-whitelist.ts --network localhost
const run = async () => {
    console.log(`Start whitelisting sDAI on ${hardhat_1.network.name}...`);
    ...
    const sdaiWhitelistSecurity = new scope_sdai_1.SdaiWhitelist(process.env.INVESTMENT_ROLES_ADDRESS, ledgerSigner);
